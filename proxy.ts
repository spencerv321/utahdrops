...
/** Refresh the Supabase auth session on every matched request (Next 16 proxy). */
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|api/cron|api/events|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
};
